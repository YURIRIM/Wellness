...
CREATE TABLE ATTACHMENT (
    ...
    UUID            RAW(16)       CONSTRAINT UK_ATTACHMENT_UUID UNIQUE,
    FILE_CONTENT    BLOB,
...
CREATE TABLE PROFILE (
    ...
    PICTURE           BLOB,
    BIO               VARCHAR2(330),
    WATERMARK_TYPE    VARCHAR2(1)   CONSTRAINT CK_PROFILE_WT CHECK (WATERMARK_TYPE IN ('D','F','N')),
    WATERMARK         BLOB,
...
COMMENT ON COLUMN PROFILE.WATERMARK_TYPE IS '워터마크 종류 (D:디폴트 F:개인 N:없음)';
