...
CREATE TABLE CHALLENGE (
    ...
    END_DATE          TIMESTAMP,
    STATUS            CHAR(1)       CONSTRAINT CK_CHALLENGE_STATUS CHECK (STATUS IN ('Y','N','D')),
    PICTURE_REQUIRED  CHAR(1)       CONSTRAINT CK_CHALLENGE_PICTURE_REQUIRED CHECK (PICTURE_REQUIRED IN ('Y','O','N')),
    REPLY_REQUIRED    CHAR(1)       CONSTRAINT CK_CHALLENGE_REPLY_REQUIRED CHECK (REPLY_REQUIRED IN ('Y','O','N'))
);
...
CREATE TABLE CHALLENGE_COMMENT (
    ...
    REPLY             VARCHAR2(3300),
    STATUS            CHAR(1)       CONSTRAINT CK_COMMENT_STATUS CHECK (STATUS IN ('Y','N'))
);
...
CREATE TABLE ATTACHMENT (
    ...
    STATUS          CHAR(1)       CONSTRAINT CK_ATTACHMENT_STATUS CHECK (STATUS IN ('Y','N'))
);
