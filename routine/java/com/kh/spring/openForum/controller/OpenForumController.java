...
public class OpenForumController {
	...
	//게시물 리스트 페이지로 이등 메소드
	@GetMapping("/list")
	public String opemForumList(@RequestParam(value="page",defaultValue="1")
								int currentPage,
								Model model) {
	...
	public String saveFile (MultipartFile uploadFile 
		...
		//String savePath = session.getServletContext().getRealPath("/resources/uploadFiles/"); //6.서버에 업로드 처리할 때 물리적인 경로 추출하기
