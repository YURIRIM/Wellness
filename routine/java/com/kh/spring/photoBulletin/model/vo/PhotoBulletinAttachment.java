...
public class PhotoBulletinAttachment {
	private int fileId;//FILE_ID	NUMBER	No		1	첨부파일번호
	private int postId; //POST_ID	NUMBER	No		2	게시물번호(운동게시판)
	...
	private String fileType; //FILE_TYPE	VARCHAR2(50 BYTE)	Yes		5	파일유형
	private int fileSize;//FILE_SIZE	NUMBER	Yes		6	파일크기
	private Date uploadDate; //UPLOAD_DATE	DATE	Yes		7	업로드일
	private char isMain;//IS_MAIN	CHAR(1 BYTE)	Yes		8	커버사진
}
